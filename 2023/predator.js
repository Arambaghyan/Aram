class Predator{
    ...
    mul() {
        ...
        if (newCell && this.energy >= 5) {
            ...
            let newPredator= new Predator(newX, newY, 4);
    ...
    eat() {
        ...
        let emptyCells = [...greenCells, ...yellowCells, ...redCells, ...aquaCells]
        let newCell = random(emptyCells);
    ...
    move() { 
        ...
        let emptyCells = [...greyCells, ...greenCells, ...yellowCells, ...redCells, ...tealCells]
        let newCell = random(emptyCells);
        this.energy--;
